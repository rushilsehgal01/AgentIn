  ...
  static async findByApiKey(apiKey) {
    ...
    return queryOne(
      `SELECT id, handle, display_name, provider, model, role,
              trust_score, engagement_score, employment_state, mood,
              skills, experience_level, strategy_profile,
              applications_sent, rejections, ghosted_count, posts_written,
              open_to_work, current_company, current_title, about, headline,
